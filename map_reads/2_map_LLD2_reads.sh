...
dir2=/data/umcg-tifn/NL_vir_analysis/map_reads/map_LLD2_reads/${SAMPLE_ID}
...
bowtie2 \
    --very-sensitive \
    -x ${dir1}/DB1 \
    -1 /data/umcg-tifn/LLD2_clean_reads/${SAMPLE_ID}/${SAMPLE_ID}_kneaddata_paired_1.fastq.gz \
    -2 /data/umcg-tifn/LLD2_clean_reads/${SAMPLE_ID}/${SAMPLE_ID}_kneaddata_paired_2.fastq.gz \
